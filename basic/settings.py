...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-JtpSYFJsoSYcrvKGrESJbOA3J84ueJ2toqn8eq5s")
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="basic"),
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="ibrahimshaban1994@gmail.com")
...
LOGGING = {
    ...
    "loggers": {
        ...
        "basic": {
            "handlers": ["console"],
            "level": env("BASIC_LOG_LEVEL", default="INFO"),
        },
    },
}
